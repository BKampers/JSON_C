...
${OBJECTDIR}/JsonGenerator.o: JsonGenerator.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JsonGenerator.o JsonGenerator.c
...
${TESTDIR}/tests/parser_test.o: tests/parser_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/parser_test.o tests/parser_test.c


${TESTDIR}/tests/text_test.o: tests/text_test.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/text_test.o tests/text_test.c
...
${OBJECTDIR}/JsonGenerator_nomain.o: ${OBJECTDIR}/JsonGenerator.o JsonGenerator.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JsonGenerator_nomain.o JsonGenerator.c;\
	else  \
...
${OBJECTDIR}/JsonParser_nomain.o: ${OBJECTDIR}/JsonParser.o JsonParser.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -I. -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/JsonParser_nomain.o JsonParser.c;\
	else  \
